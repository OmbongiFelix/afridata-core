...
class IsOwnerOrAdmin(BasePermission):
    ...
    def has_permission(self, request, view):
        # Returning False here (not raising) makes DRF emit 401 for
        # unauthenticated requests instead of 403, because DRF checks
        # WWW-Authenticate headers and upgrades the response code.
